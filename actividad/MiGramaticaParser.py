...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\7\t\\\n\t\f\t\16\t_\13\t\3\t\2\3\20\n\2\4\6\b\n\f\16")
        buf.write("\20\2\5\3\2\n\r\3\2\16\17\3\2\20\21\2`\2\23\3\2\2\2\4")
        buf.write("\33\3\2\2\2\69\3\2\2\2\b;\3\2\2\2\n?\3\2\2\2\fC\3\2\2")
        buf.write("\2\16G\3\2\2\2\20S\3\2\2\2\22\24\5\4\3\2\23\22\3\2\2\2")
        buf.write("\24\25\3\2\2\2\25\23\3\2\2\2\25\26\3\2\2\2\26\27\3\2\2")
        buf.write("\2\27\30\7\2\2\3\30\3\3\2\2\2\31\34\5\6\4\2\32\34\5\16")
        buf.write("\b\2\33\31\3\2\2\2\33\32\3\2\2\2\34\5\3\2\2\2\35\36\7")
        buf.write("\3\2\2\36\37\7\4\2\2\37 \5\b\5\2 !\7\5\2\2!\"\5\n\6\2")
        buf.write("\"#\7\5\2\2#$\5\f\7\2$%\7\6\2\2%)\7\7\2\2&(\5\4\3\2\'")
        buf.write("&\3\2\2\2(+\3\2\2\2)\'\3\2\2\2)*\3\2\2\2*,\3\2\2\2+)\3")
        buf.write("\2\2\2,-\7\b\2\2-:\3\2\2\2./\7\3\2\2/\60\7\4\2\2\60\61")
        buf.write("\5\b\5\2\61\62\7\5\2\2\62\63\5\n\6\2\63\64\7\5\2\2\64")
        buf.write("\65\5\f\7\2\65\66\7\6\2\2\66\67\7\7\2\2\678\7\b\2\28:")
        buf.write("\3\2\2\29\35\3\2\2\29.\3\2\2\2:\7\3\2\2\2;<\7\22\2\2<")
        buf.write("=\7\t\2\2=>\5\20\t\2>\t\3\2\2\2?@\7\22\2\2@A\t\2\2\2A")
        buf.write("B\7\23\2\2B\13\3\2\2\2CD\7\22\2\2DE\7\t\2\2EF\5\20\t\2")
        buf.write("F\r\3\2\2\2GH\7\22\2\2HI\7\t\2\2IJ\5\20\t\2JK\7\5\2\2")
        buf.write("K\17\3\2\2\2LM\b\t\1\2MT\7\23\2\2NT\7\22\2\2OP\7\4\2\2")
        buf.write("PQ\5\20\t\2QR\7\6\2\2RT\3\2\2\2SL\3\2\2\2SN\3\2\2\2SO")
        buf.write("\3\2\2\2T]\3\2\2\2UV\f\7\2\2VW\t\3\2\2W\\\5\20\t\bXY\f")
        buf.write("\6\2\2YZ\t\4\2\2Z\\\5\20\t\7[U\3\2\2\2[X\3\2\2\2\\_\3")
        buf.write("\2\2\2][\3\2\2\2]^\3\2\2\2^\21\3\2\2\2_]\3\2\2\2\t\25")
        buf.write("\33)9S[]")
        return buf.getvalue()
...
class MiGramaticaParser ( Parser ):
    ...
    def programa(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==MiGramaticaParser.T__0 or _la==MiGramaticaParser.ID):
                    break
    ...
    def sentencia(self):
        ...
        try:
            ...
            if token in [MiGramaticaParser.T__0]:
                self.enterOuterAlt(localctx, 1)
                self.state = 23
                self.forStmt()
                pass
    ...
    class ForLoopWithBodyContext(ForStmtContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterForLoopWithBody" ):
                listener.enterForLoopWithBody(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitForLoopWithBody" ):
                listener.exitForLoopWithBody(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitForLoopWithBody" ):
                return visitor.visitForLoopWithBody(self)
            else:
                return visitor.visitChildren(self)


    class ForLoopEmptyContext(ForStmtContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterForLoopEmpty" ):
                listener.enterForLoopEmpty(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitForLoopEmpty" ):
                listener.exitForLoopEmpty(self)

        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitForLoopEmpty" ):
                return visitor.visitForLoopEmpty(self)
            else:
                return visitor.visitChildren(self)
    ...
    def forStmt(self):
        ...
        try:
            ...
            if la_ == 1:
                localctx = MiGramaticaParser.ForLoopWithBodyContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 27
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                while _la==MiGramaticaParser.T__0 or _la==MiGramaticaParser.ID:
                    self.state = 36
                    self.sentencia()
                    self.state = 41
                    self._errHandler.sync(self)
                ...
                localctx = MiGramaticaParser.ForLoopEmptyContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 44
                self.match(MiGramaticaParser.T__0)
                self.state = 45
    ...
    def expresion(self, _p:int=0):
        ...
        try:
            ...
            if token in [MiGramaticaParser.INT]:
                ...
                self.match(MiGramaticaParser.ID)
                pass
            elif token in [MiGramaticaParser.T__1]:
